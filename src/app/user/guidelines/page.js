...
export default function GuidelinesPage() {
  ...
  return (
    <div
      className="flex flex-col p-4 max-w-full min-h-screen"
      style={themeStyles.container}
    >
      <div className="flex items-center mb-6">
        <h1 className="text-2xl font-bold" style={themeStyles.title}>
          User Guidelines
        </h1>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Do&apos;s Section */}
        <div
          className="guideline-card rounded-xl overflow-hidden border"
            ...
            <ul className="space-y-4">
              <li className="guideline-item flex items-start">
                <CheckCircle2
                  ...
                  size={18}
                  style={themeStyles.dosIcon}
                />
                <span style={themeStyles.listItemText}>
                  Verify receipt numbers before submission
                </span>
              </li>
              <li className="guideline-item flex items-start">
                <CheckCircle2
                ...
                />
                <span style={themeStyles.listItemText}>
                  Double-check names for accurate spelling
                </span>
              </li>
              <li className="guideline-item flex items-start">
                <CheckCircle2
                ...
                />
                <span style={themeStyles.listItemText}>
                  Select the correct Hissa type (Qurbani/Aqeeqah)
                </span>
              </li>
              <li className="guideline-item flex items-start">
                <CheckCircle2
                ...
                />
                <span style={themeStyles.listItemText}>
                  Ensure mobile numbers are correct if provided
                </span>
              </li>
              <li className="guideline-item flex items-start">
                <CheckCircle2
              ...
              <li className="guideline-item flex items-start">
                ...
                />
                <span style={themeStyles.listItemText}>
                  Use the edit feature to correct mistakes
                </span>
              </li>
              <li className="guideline-item flex items-start">
                <CheckCircle2
                ...
                />
                <span style={themeStyles.listItemText}>
                  Try refreshing the page if the interface not loading properly
                </span>
              </li>
            </ul>
          </div>
            ...
            <ul className="space-y-4">
              <li className="guideline-item flex items-start">
                <XCircle
                  className="mt-1 mr-3 flex-shrink-0"
                  size={18}
                  style={themeStyles.dontsIcon}
                />
                <span style={themeStyles.listItemText}>
                  Don&apos;t exceed the 7 Hissa limit per receipt
                </span>
              </li>
              <li className="guideline-item flex items-start">
                <XCircle
              ...
              <li className="guideline-item flex items-start">
                ...
                />
                <span style={themeStyles.listItemText}>
                  Don&apos;t use the system on public computers without logging out
                </span>
              </li>
            </ul>
          </div>
      ...
      <div
        className="guideline-card mt-8 rounded-xl overflow-hidden border"
        style={themeStyles.card}
      >
            ...
            <div>
              ...
              >
                <CheckCircle2
                  className="mr-2"
                  size={18}
                  style={themeStyles.generalIcon}
                />
                Data Entry
              </h3>
              <ul className="space-y-2" style={themeStyles.listItemText}>
                <li className="pl-6">
                  • Always verify receipt numbers with physical copies
                </li>
                <li className="pl-6">
                  • Use full names as they appear on official documents
                </li>
                <li className="pl-6">
                  • Double-check mobile numbers before saving
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2" style={themeStyles.listItemText}>
                <li className="pl-6">
                  • Mixing up Qurbani and Aqeeqah entries
                </li>
